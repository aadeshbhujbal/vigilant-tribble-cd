// Climate Questions Data - Part 2 (Questions 16-35)
export const climateQuestions2 = [
  ...
  {
    id: 'q17',
    question: 'How does the organization ensure supply chain resilience to climate-related risks?',
    category: 'Risk Management',
    subcategory: 'Supply Chain Risks',
    required: false,
    helpText: 'Describe supplier assessment, risk mitigation, and resilience building measures',
  },
  {
    id: 'q18',
    ...
    required: false,
    helpText: 'Include information about R&D investments, partnerships, and innovation initiatives',
  },
  {
    id: 'q19',
    question: 'How does the organization assess the climate impact of its products and services?',
    category: 'Environmental Impact',
    subcategory: 'Product Impact',
    required: false,
    helpText: 'Describe lifecycle assessments, carbon footprint analysis, and impact measurement',
  },
  {
    id: 'q20',
  ...
  {
    id: 'q21',
    question: 'How does the organization manage climate-related regulatory compliance?',
    category: 'Compliance',
  ...
  {
    id: 'q23',
    question: 'How does the organization assess and manage climate-related reputational risks?',
    category: 'Risk Management',
  ...
  {
    id: 'q24',
    question: 'What climate-related data and information systems does the organization use?',
    category: 'Data Management',
    subcategory: 'Information Systems',
    required: false,
    helpText: 'Include information about data collection, management systems, and analytical tools',
  },
  {
    id: 'q25',
    ...
    required: false,
    helpText: 'Describe data validation, verification processes, and quality assurance measures',
  },
  {
    id: 'q26',
  ...
  {
    id: 'q31',
    question: 'How does the organization assess the climate impact of its investment portfolio?',
  ...
  },
  {
    ...
    required: true,
    helpText: 'Include information about TCFD, GRI, SASB, and other relevant reporting frameworks',
  },
  {
    id: 'q33',
  ...
  {
    id: 'q34',
    question: 'What climate-related forward-looking information does the organization provide?',
    category: 'Reporting',
    subcategory: 'Forward-Looking Information',
    required: false,
    helpText: 'Include information about projections, forecasts, and forward-looking statements',
  },
  {
    id: 'q35',
